 ...
 */
public class AHPWeighter implements IWeighter {
     ...
     */
    public Set<WeightResult> elicitateWeights(Path comparisonMatricesDirectory, Path tempWeightsDirectory) {
        ...
        // Transform linguistic values into decimal values
        // {VL: 1/9. SL: 1/4. EQ: 1. SH: 4. VH: 9}
        File[] matrcies = comparisonMatricesDirectory.toFile().listFiles();
    ...
    public String getName() {
        return "pique.calibration.AHPWeighter";
    }
