...
class Weighter {
     ...
     */
    static Set<WeightResult> elicitateWeights(Path comparisonMatricesDirectory, Path tempResultsDirectory) {
        ...
        try {
            FileUtils.deleteDirectory(tempResultsDirectory.toFile());
        } catch (IOException e) {
            e.printStackTrace();
        }
